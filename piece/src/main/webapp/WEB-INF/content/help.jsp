		...
		<div id="index-friend-request-list" class="ui-content">
			...
			<ul data-role="listview" class="pin-list" data-inset="true">
				...
				<li>
					...
					<p>プロジェクトトップの[Task]タブを押して表示されるタスク名の左に表示されている<i class="fa fa-square-o"></i>四角をタップすると<i class="fa fa-check-square-o"></i>このように「チェック」タスク完了となります。もう一度押すと再度未完了状態になります。</p>
